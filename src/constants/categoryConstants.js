...
export const CATEGORY_LIST_BYID_REQUEST = 'CATEGORY_LIST_BYID_REQUEST'
export const CATEGORY_LIST_BYID_SUCCESS = 'CATEGORY_LIST_BYID_SUCCESS'
export const CATEGORY_LIST_BYID_FAIL = 'CATEGORY_LIST_BYID_FAIL'
