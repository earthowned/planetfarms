...
export const USER_CONFORM_CODE_REQUEST = 'USER_CONFORM_CODE_REQUEST'
export const USER_CONFORM_CODE_SUCCESS = 'USER_CONFORM_CODE_SUCCESS'
export const USER_CONFORM_CODE_FAIL = 'USER_CONFORM_CODE_FAIL'
