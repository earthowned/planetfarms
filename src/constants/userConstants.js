...
export const CONFORM_SIGNUP_REQUEST = 'CONFORM_SIGNUP_REQUEST'
export const CONFORM_SIGNUP_SUCCESS = 'CONFORM_SIGNUP_SUCCESS'
export const CONFORM_SIGNUP_FAIL = 'CONFORM_SIGNUP_FAIL'

export const FORGET_PASSWORD_REQUEST = 'FORGET_PASSWORD_REQUEST'
export const FORGET_PASSWORD_SUCCESS = 'FORGET_PASSWORD_SUCCESS'
export const FORGET_PASSWORD_FAIL = 'FORGET_PASSWORD_FAIL'

export const FORGET_PASSWORD_CONFORM_REQUEST = 'FORGET_PASSWORD_CONFORM_REQUEST'
export const FORGET_PASSWORD_CONFORM_SUCCESS = 'FORGET_PASSWORD_CONFORM_SUCCESS'
export const FORGET_PASSWORD_CONFORM_FAIL = 'FORGET_PASSWORD_CONFORM_FAIL'
