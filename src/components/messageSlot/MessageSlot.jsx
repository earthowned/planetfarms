...
const messages = [
  {
    ...
    message:
      'Hi there! Can you help with  course Farming Business 2020 "?" I saw you in “Also study this course and well',
    date: "08:30 AM",
  },
  {
    sender: "Mikail",
  ...
  return (
    <>
      <div className="message-container">
        ...
        <h4 className="message-slot-header">
          Mikhail has been added Cooper James to chat
        </h4>
