...
function Frame19433(props) {
  ...
  return (
    <div className="frame-19434">
      ...
      <div className="rectangle-8598"></div>
      <Frame2303 vector={frame2303Props.vector} vector2={frame2303Props.vector2} className="frame-23034" />
      <Group1943
