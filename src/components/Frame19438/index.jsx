...
import "./Frame19438.css";

function Frame19438(props) {
  const {
    text255,
    text256,
    text257,
  ...
  return (
    <div className="frame-19439">
      <Frame1945 frame2891Props={frame1945Props.frame2891Props} frameProps={frame1945Props.frameProps} />
      <div className="frame-194410">
        <Link to="/3-community-page-news">
          <div className="frame-28479">
            <Frame1953 text37={frame1953Props.text37} usermanagementProps={frame1953Props.usermanagementProps} />
          </div>
        </Link>
        <Link to="/5-1-all-groups">
          <div className="frame-197410">
            <div className="text-25">{text255}</div>
          </div>
        </Link>
        <Link to="/81community-members">
          <div className="frame-19756">
            <div className="text-25">{text256}</div>
          </div>
        </Link>
        <Link to="/9-1-all-enterprises">
          <div className="frame-19766">
            <div className="text-25">{text257}</div>
          </div>
        </Link>
        <div className="frame-19778"></div>
        <div className="frame-19788"></div>
      </div>
      ...
      <div className="rectangle-85914"></div>
      <Frame2303 vector={frame2303Props.vector} vector2={frame2303Props.vector2} className="frame-23039" />
      <div className="group-19436">
        <div className="frame-27915">
          <div className="rectangle-859-15"></div>
          <Group1942 {...group1942Props} />
          <Link to="/4-2-calendar-with-events">
            <div className="frame-28514 border-1px-caribbean-green">
              <div className="text-261 valign-text-middle">{text261}</div>
            </div>
          </Link>
        </div>
        <img className="union5" src={union} />
        <Frame28912
