...
function Frame194322(props) {
  ...
  return (
    <div className="frame-194323">
      ...
      <div className="rectangle-85928"></div>
      <Frame2303 vector={frame2303Props.vector} vector2={frame2303Props.vector2} className="frame-230323" />
      <Group1943
