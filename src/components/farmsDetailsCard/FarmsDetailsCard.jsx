      ...
      <div className="group-view-inner-content">
        ...
        <div>
          <div className="community-group-view-filter-container">
            <div
              className="secondary-btn community-group-view-btn"
              onClick={handleFollowClick}
            >
              <span>You’re follower</span>
            ...
            {followers && (
              <div className="follow-option">
                ...
                <div className="follow-option-item color-red">Report group</div>
              </div>
            )}
          </div>
        </div>
