...
function Frame194327(props) {
  ...
  return (
    <div className="frame-194328">
      ...
      <div className="rectangle-85933"></div>
      <Frame2303 vector={frame2303Props.vector} vector2={frame2303Props.vector2} className="frame-230328" />
      <Group1943
