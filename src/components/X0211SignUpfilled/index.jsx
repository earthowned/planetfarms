...
import "./X0211SignUpfilled.css";

function X0211SignUpfilled(props) {
  const {
    vector,
    vector2,
    vector3,
  ...
  return (
    <div class="container-center-horizontal">
      <div className="x02-1-1-sign-up-filled screen ">
        <div className="flex-col">
            ...
            <div className="frame-1931">
                ...
                <div className="frame-65-1 border-1px-onyx">
                  <div className="frame-1934">
                    ...
                    <div className="frame-9-1">
                      ...
                      <p className="text-1 ibmplexsans-regular-normal-quarter-spanish-white-16px">{text1}</p>
                    </div>
                  </div>
                  <Eyeoffoutline2
              ...
              <div className="frame-1935">
                <div className="frame-11">
                  ...
                  <p className="text-2 ibmplexsans-regular-normal-quarter-spanish-white-16px">
                    <span className="span0-dvbjmv">{spanText}</span>
                    <span className="span1-dvbjmv">{spanText2}</span>
                    <span className="span2-dvbjmv">{spanText3}</span>
                  </p>
                </div>
          ...
          <div className="frame-93 border-1px-onyx">
            <p className="text-4 ibmplexsans-semi-bold-white-16px">
...
export default X0211SignUpfilled;
