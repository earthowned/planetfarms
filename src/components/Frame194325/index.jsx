...
import "./Frame194325.css";

function Frame194325(props) {
  const {
    frame1945Props,
    frame1953Props,
    frame1976Props,
  ...
  return (
    <div className="frame-194326">
      ...
      <div className="rectangle-85931"></div>
      <Frame2303 vector={frame2303Props.vector} vector2={frame2303Props.vector2} className="frame-230326" />
      <Group1943
