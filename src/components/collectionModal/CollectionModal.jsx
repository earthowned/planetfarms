...
const CollectionModal = ({ setActive, openAddCollection, name }) => {
  ...
  const [resourceDescriptionError, setResourceDescriptionError] =
    useState(false);
          ...
          <div className="collection-modal-inner-container">
            ...
            {pathname === "/library" ? (
              <>
                <div className="collection-input-container">
                  <input
                    ...
                    onChange={(e) => resourceTitleChange(e)}
                  ...
                  <input
                    ...
                    onChange={(e) => resourceDescriptionChange(e)}
              ...
              <>
                ...
                >
                  <img src="/img/plus.svg" alt="Add Files" />
                  <button type="button">{name || "Add files"}</button>
                </div>
                <button
                  type="button"
                  className="default-btn btn-size"
