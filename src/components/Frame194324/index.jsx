...
import "./Frame194324.css";

function Frame194324(props) {
  const {
    text988,
    text1006,
    union,
  ...
  return (
    <div className="frame-194325">
      ...
      <div className="rectangle-85930"></div>
      <Frame2303 vector={frame2303Props.vector} vector2={frame2303Props.vector2} className="frame-230325" />
      <div className="group-194316">
        <div className="frame-279115">
          <div className="rectangle-859-115"></div>
          <Group1942 {...group1942Props} />
          <Link to="/4-2-calendar-with-events">
            <div className="frame-28536 border-1px-caribbean-green">
              <div className="text-1006 valign-text-middle">{text1006}</div>
            </div>
          </Link>
        </div>
        <img className="union16" src={union} />
        <Frame28912
