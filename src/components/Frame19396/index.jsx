...
import "./Frame19396.css";

function Frame19396(props) {
  const { frame3318Props, frame33183Props, frame33184Props } = props;

  return (
    <div className="frame-19398">
      <Link to="/32-add-news-video">
        <div className="frame-33175 border-0-5px-quarter-spanish-white">
      ...
      <Link to="/3-4-add-new-block-photo">
        <div className="frame-33189 border-0-5px-quarter-spanish-white">
      ...
      <Link to="/3-3-add-new-block-text-1">
        <div className="frame-33195 border-0-5px-quarter-spanish-white">
