...
function Frame194311(props) {
  ...
  return (
    <div className="frame-194312">
      ...
      <div className="rectangle-85917"></div>
      <Frame2303 vector={frame2303Props.vector} vector2={frame2303Props.vector2} className="frame-230312" />
      <Group1943
