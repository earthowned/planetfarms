...
function Frame194310(props) {
  ...
  return (
    <div className="frame-194311">
      ...
      <Frame1948 graduationCap={frame1948Props.graduationCap} text42={frame1948Props.text42} className="frame-19484" />
      <div className="rectangle-85916"></div>
      <Frame2303 vector={frame2303Props.vector} vector2={frame2303Props.vector2} className="frame-230311" />
      <Group1943
