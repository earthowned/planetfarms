...
import "./X0111Loginfiled.css";

function X0111Loginfiled(props) {
  const {
    vector,
    vector2,
    vector3,
  ...
  return (
    <div class="container-center-horizontal">
      <div className="x01-1-1-login-filed screen ">
          ...
          <div className="frame-1932">
            ...
            <div className="frame-1931">
              <div className="frame-4">
                <div className="frame-65 border-1px-white">
...
export default X0111Loginfiled;
