...
//             <div className="farming valign-text-middle ibmplexsans-semi-bold-caribbean-green-14px">
//               {farming}
//             </div>
//             <div className="text-2 valign-text-middle ibmplexsans-semi-bold-quarter-spanish-white-24px">
//               {text2}
//             </div>
//           </div>
...
//             style={{ backgroundImage: `url(${playButton1})` }}
//           />
//         </div>
//         <div className="frame-3239" />
//         <p className="text-5 valign-text-middle inter-medium-quarter-spanish-white-16px">
//           {text5}
//         </p>
//       </div>
//     </div>
