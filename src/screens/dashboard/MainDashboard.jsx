            ...
            <div className="dashboard-info">
              ...
              <div className="flex-col-6">
                <div className="info-my-detail">
                  ...
                  <p className="text-1 ibmplexsans-regular-normal-monsoon-16px">
                    Last visit: {moment(user?.lastLogin).format("ddd LL")}
                  </p>
                </div>
                <div className="info-my-community">
                  <div className="text-1 ibmplexsans-regular-normal-monsoon-16px">
                    Follow {user?.communities} communities
                  </div>
...
function ScrollItems({ head }) {
  ...
  const { scrollLeftActive, scrollActive, scrollRight, scrollLeft } =
    useScroll(scrollRef);
  return (
    <>
      ...
      {scrollActive && (
        <img
          className="scroll-dashboard-icon"
      ...
      {scrollLeftActive && (
        <img
          className="scroll-dashboard-left-icon"
          src="/img/scroll-icon.svg"
