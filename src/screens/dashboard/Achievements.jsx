          ...
          <div className="achievements-hero border-1px-onyx">
            <div className="achievements-info">
              ...
              <div className="flex-col-4">
                <div className="name ibmplexsans-semi-bold-quarter-spanish-white-24px">
                  Mikhail Ugryumov
                </div>
                <div className="your-achievements-level border-1px-onyx">
                  ...
                  <div className="frame-3055">
                    ...
                    <p className="text-14 valign-text-middle">
                      You need to finish one more achievement to have a new
                      level
                    </p>
                  </div>
                </div>
                ...
                <div className="total-achievements-progressbar">
                  <div className="overlap-group-5">
                    <div className="frame-3052">
                      <div className="phone valign-text-middle">
                        56/245 (26%)
                      </div>
                    </div>
                    <div className="frame-3053" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="achievements-progressbar">
              {/* header */}
              <h4 className="achievements-progressbar--header">
                Achievements in progress
              </h4>

              <div className="achievements-progress-table">
                <ProgressBar
                  text="Be a member of 10 communities at least (5/10)"
                  percent="50"
                />
                <ProgressBar
                  text="Finish five star course in this year"
                  percent="0"
                />
                <ProgressBar
                  text="Make 15 unique posts in your own groups (14/15)"
                  percent="97"
                />
                <ProgressBar
                  text="Be a member of 10 communities at least (7/10)"
                  percent="73"
                />
                <ProgressBar
                  text="Make 15 unique posts in your own groups (14/15)"
                ...
                />
                <ProgressBar
                  text="Make 15 unique posts in your own groups (12/15)"
                  percent="87"
                />
              </div>
            </div>
            <div className="finished-achievements-1">
              ...
              <div className="finished-achievements">
                <ProgressBar
                  text="Be a member of 10 communities at least (10/10)"
                  percent="70"
                />
                <ProgressBar
                  text="Make 15 unique posts in your own groups (15/15)"
                  percent="95"
                />
              </div>
            </div>
