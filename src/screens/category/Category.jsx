      ...
      <div>
        <div className="collection-modal-inner-container">
          <CollectionModalHeader
            title={data ? "Update Category" : "Create Category"}
            clickHandler={clearInput}
          />
          <form
            onSubmit={
              data ? handleSubmit(updateCategory) : handleSubmit(addCategory)
            }
          >
            ...
            />
            {data ? (
              <button className="primary-btn category-btn" type="submit">
                Update Category
              </button>
            ) : (
              <button className="primary-btn category-btn" type="submit">
