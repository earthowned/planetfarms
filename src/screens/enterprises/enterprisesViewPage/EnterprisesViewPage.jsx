      ...
      <div className="title">
        ...
        <div className="chevron-right-outline-1-2 chevron-right-outline-1-1">
          <div className="enterprises-overlap">
            <img src="/img/chevron-right-outline.svg" alt="" />
          </div>
        </div>
      </div>
      ...
      {isActive && (
        <div className="accordin-content">
          <div className="accordin-button">
            <button type="button" className="btn-accordin tasks-button">
              {" "}
              <img src="/img/checkmark-square.svg" alt="" /> Tasks
            </button>
            <button type="button" className="btn-accordin">
              {" "}
              <img src="/img/dollar-sign.svg" alt="" /> Finances
            </button>
            <button type="button" className="btn-accordin">
              {" "}
              <img src="/img/pie-chart-outline.svg" alt="" /> Reports
            </button>
            <button type="button" className="btn-accordin">
              {" "}
              <img src="/img/file-text-outline.svg" alt="" /> Materials
            </button>
          </div>
        </div>
      )}
  ...
  return (
    <div className="enterprise-details">
      <FarmsDetailsCard
        ...
        followerNumber={dueToTheAdvantage}
      />
      <div className="event-messenger-container">
        <div className="event-container">
          <div className="event-container-wrapper">
            ...
            <Events event={text7} date={phone} />
            <Events event={text8} date={phone2} />
