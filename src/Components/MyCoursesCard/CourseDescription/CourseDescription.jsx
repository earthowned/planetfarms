        ...
        lessons.map((item, index) => {
          return (
            <div className="lesson-progress-content" key={index}>
              <div
                className={
                  item.unlock ? "circle-wrapper-active" : "circle-wrapper"
                }
              >
...
const CourseDetail = ({ setFeedbackModal, unpaid, setPurchaseModal, data }) => {
  return (
    <div className="description-course-page">
      <img
        className="bg-image"
        src={`${GET_THUMBNAIL}${data?.thumbnail}`}
        alt=""
      />
    ...
    <div className="lesson-card-wrapper">
      ...
      <div className={data.finish ? "lesson-card lock-active" : "lesson-card"}>
        ...
        <div className="lesson-card-content">
          ...
          <button onClick={() => history.push("/mycoursepage/lesson-1")}>
            {data.lesson}
          </button>
        </div>
      </div>
