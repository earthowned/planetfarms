        ...
        <div className="question-answer-container">
                <div className="question-container">
                    ...
                    <input
                        ...
                        value={item.question}
                        onChange={(e) => setQuestions((e) => setQuestions({}))}
                    />
                    </div>
              ...
              <div className="test-answers-wrapper">
                  <div className="test-correct-answer">
                      ...
                      <input
                            ...
                            onChange={(e) => setQuestions([ {corectanswer: e.target.value}])}
                        />
                        </div>
                  ...
                  {/* <div className="test-answer-options">
                     <input
                        ...
                        />
                    <button><img src="/img/plus.svg" alt="add icon" /> <h4>Add new answer</h4></button>
                  </div> */}
              </div>
              </div>
    )
