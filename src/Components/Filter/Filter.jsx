    ...
    return (
        <>
        {
            ...
            <div onClick={() => setActive(!active)} className="filter-title">
                <img src='/img/funnel-outline.svg' /> {name || "filter by"} <img className="dropdown-icon" src="/img/chevron-right-outline.svg" ></img>
                </div>
            ...
            <div onClick={() => setActive(!active)} className="filter-title">
                ...
                : "Saved collection"
                } <img className="dropdown-icon" src="/img/chevron-right-outline.svg" ></img>
                </div>
                {active && <ul className="filter-dropdown">
                        {
                            data.length && data.map(item => (
                                <Link className="nav-link" to={`${ (item === "All files") 
                                ? "/library" : (item === "My library & collections") ? "/library/collection"
                                : (item === "Users collection") ? "/library/collection/users"
                                : "/library/collection/saved"}`}><li  onClick={() => setActive(false)}>{item}
                                </li>
                                </Link>
                                ))
                        }
