  ...
  return (
    <form className='sign'>
      ...
      <div className='sign-container'>
        ...
        <div className='sign-remember sign-remember-signup'>
          <div className='sign-remember-signupCheckBtn'>
            <div class='sign-remember-checkboxAndError'>
              <div className='sign-remember-terms'>
                <Checkbox
                  ...
                  setTerms={setTerms}
                />
                <div className='sign-remember-me white16px'>
                  {spanText} {spanText3}
                </div>
              </div>
              <p className='sign-remember-me-errorMsg'>
                {termsError ? 'Please read the terms of service' : ' '}
              </p>
            </div>
            <div className='sign-btnSignUp'>
        ...
        <div className='sign-option'>
          <p className='sign-option-span sign-option-span-1'>
            Already have an Account?
          </p>
          <Link className='sign-option-span sign-option-span-2' to='/'>
            {signIn}
          </Link>
        </div>
      </div>
