    ...
    <>
      <header className='header-container'>
        ...
        <ul>
          ...
          <li>{modalActive ? <SignOutModel setModalActive={setModalActive} /> : <img onClick={(e) => SignOutModal(e)} src='/img/avatar-img.svg' alt='avatar-img' />}</li>
        </ul>
      </header>
    </>
  )
