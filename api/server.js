...
const collectionUserRoutes = require('./routes/collectionUserRouter')
const resourceUserRoutes = require('./routes/resourceUserRouter')
...
app.use('/api/collectionUser', collectionUserRoutes)
app.use('/api/resourceUser', resourceUserRoutes)
