...
const courseViewRoutes = require('./routes/courseViewRouter')
...
const lessonProgressRouter = require('./routes/lessonProgressRouter')
...
app.use('/api/course-views', courseViewRoutes)
app.use('/api/news', newsRoutes)
app.use('/api/categories', categoriesRoutes)
app.use('/api/courses/:courseId/lessons', lessonsRoutes)
app.use('/api/courses/:courseId/lessons/:lessonId/materials', materialRouter)
